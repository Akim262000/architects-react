        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-7 d-none d-xxl-block">
            <div class="w-100 h-100 position-relative">
              <img
                class="about-img-one position-absolute"
          ...
          <div class="col-12 col-lg-5 d-flex flex-column align-items-start justify-content-end">
            ...
            >
              Read More
              <img class="ms-3" src="./images/arrow-next.svg" alt="arrow" />
            </a>
          </div>
        </div>
      </section>
      ...
      <section class="our-projects mt-120">
        ...
        <div class="row gx-4 gy-4">
          <div class="col-12 col-md-6 d-flex">
            ...
            >
              <img class="" src="./images/our-project-1.jpg" alt="" />
              <div
              ...
              >
                ...
                <div class="d-flex flex-row align-items-center mt-3">
                  ...
                  <img
                    class="ms-20"
                    src="./images/arrow-next-white.svg"
          ...
          <div class="col-12 col-md-6 d-flex">
            <div class="h-100 w-100 our-project-two">
              <img class="" src="./images/our-project-2.jpg" alt="" />
            </div>
          </div>
          <div class="col-12 col-md-3 d-flex">
            <div class="h-100 w-100 our-project-three">
              <img class="" src="./images/our-project-3.jpg" alt="" />
            </div>
          </div>
          <div class="col-12 col-md-5 d-flex">
            <div class="h-100 w-100 our-project-four">
              <img class="" src="./images/our-project-4.jpg" alt="" />
            </div>
          </div>
          <div class="col-12 col-md-4 d-flex">
            <div class="h-100 w-100 our-project-five">
              <img class="" src="./images/our-project-5.jpg" alt="" />
            </div>
          </div>
          <div class="col-auto ms-auto">
            <div class="py-4 px-40 bg-dark-gray">
              ...
              >
                All Projects
                <img class="ms-2" src="./images/arrow-next-white.svg" alt="" />
              </a>
            </div>
          </div>
        </div>
