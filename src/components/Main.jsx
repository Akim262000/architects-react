  ...
  return (
    <>
        ...
        <div class="row d-flex align-items-end justify-content-between">
          ...
          <div class="col-12 col-md-4 d-flex flex-column align-items-center align-items-md-start order-2 order-md-1">
            <h2 class="font-64 fw-light lh-64 text-gray-two text-uppercase mb-0 d-none d-md-block">
              project
              <br />
              <span class="text-black fw-bold">Lorem</span>
            </h2>
            <div class="d-flex flex-row flex-md-column justify-content-around mt-150 mb-80 w-100">
              ...
              <div class="d-flex align-items-center mt-90">
                <span class="font-24 fw-normal text-gray-two lh-24 me-4">
                  01
                </span>
                <img src={line} alt="" />
                <span class="font-24 fw-normal text-gray-two lh-24 ms-4">
                  03
                </span>
              </div>
            </div>
        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-7 d-none d-xxl-block">
            <div class="w-100 h-100 position-relative">
              ...
              />
              <img
                class="about-img-two position-absolute"
                src={aboutTwo}
                alt="About image"
              />
              <img
                class="about-img-three position-absolute"
                src={aboutThree}
                alt="About image"
              />
            </div>
          ...
          <div class="col-12 col-lg-5 d-flex flex-column align-items-start justify-content-end">
            <h2 class="font-64 fw-light lh-64 text-gray-two text-uppercase mb-20">
              about
            </h2>
            <img
              class="d-block d-lg-none mb-3 w-100"
              src={aboutOne}
              alt="About image"
            />
            ...
            <a
              class="font-12 fw-normal text-gray-one bg-white lh-12 py-4 ps-35 pe-64 text-decoration-none text-uppercase"
              href="/#"
            >
              Read More
      ...
      <section class="main-focus mt-150">
        <h2 class="font-64 fw-light lh-64 text-gray-two mb-60">
          Main Focus/Mission Statement
        </h2>
        <div class="row d-flex justify-content-between align-items-start">
          <div class="col-12 col-xl-4 d-flex align-items-center">
            <span class="font-200 fw-bolder text-gray-three lh-200 me-30">
              1
            </span>
      ...
      <section class="our-projects mt-120">
        ...
        <div class="row gx-4 gy-4">
          <div class="col-12 col-md-6 d-flex">
            <a
              href="/#"
              class="h-100 w-100 our-project-one"
              aria-label="Посмотреть проект Sample Project"
            >
              <img class="" src={ourProjectOne} alt="" />
              <div
                class="position-absolute top-0 mt-3 mt-lg-5 ms-80"
                style={{ zindex: "5" }}
              >
                ...
                <div class="d-flex flex-row align-items-center mt-3">
                  <span class="font-12 fw-normal lh-12 ls-20 text-white">
                    View More
                  </span>
                  <img
                    class="ms-20"
          ...
          <div class="col-auto ms-auto">
            <div class="py-4 px-40 bg-dark-gray">
              <a
                href="/#"
                class="font-12 fw-normal lh-12 ls-20 text-decoration-none text-white text-uppercase"
              >
                All Projects
        ...
        <div class="row">
          <div class="col-12 col-lg-5 order-2 order-lg-1">
            <form action="">
              ...
              <div class="mb-2">
                <input
                  class="form-control font-14 fw-normal text-gray-four w-100 bg-gray-four border-gray-four py-3 px-4"
                  type="tel"
                  id="tel"
                  value={tel}
              ...
              <div class="">
                <textarea
                  class="form-control font-14 fw-normal text-gray-four contact-us-textarea w-100 bg-gray-four border-gray-four py-3 px-4"
                  value={message}
                  name=""
                  id="message"
                  placeholder="Message*"
