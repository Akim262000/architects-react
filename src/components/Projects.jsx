    ...
    <>
      <section className="our-projects">
        <h2 className="font-64 fw-light lh-64 text-gray-two mb-60 d-none d-md-block">
          Our
          <br />
          <span className="text-black fw-bold">Projects</span>
        </h2>
        <h2 className="font-64 fw-light lh-64 text-gray-two mb-60 d-block d-md-none">
          Our <span className="text-black fw-bold">Projects</span>
        </h2>
          ...
          <div className="col-12">
            <div className="row gx-0">
              ...
              <div className="col-12 col-lg-5">
                <div className="d-flex flex-column justify-content-between align-items-start bg-gray-four p-30 h-100">
                  <h4 className="font-40 fw-light text-gray-two mb-0">
                    Sample Project
                  </h4>
                  <p className="font-16 fw-light text-black mb-0 lh-24 mt-4 mt-lg-0">
                  ...
                  <Link
                    className="font-12 fw-normal text-gray-one bg-white lh-12 py-4 ps-35 pe-64 ls-20 text-decoration-none text-uppercase mt-4 mt-lg-0"
        ...
        <div className="d-flex flex-row justify-content-around justify-content-md-start mt-60 w-100">
