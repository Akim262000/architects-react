      ...
      <footer class="bg-gray-three mt-120">
        <div class="container pt-58 pb-60">
          <div class="row justify-content-between d-flex">
            ...
            <div class="col-12 col-sm-6 col-lg-2 order-2">
              <h5 class="font-16 fw-bold text-white mb-4 text-center text-md-start">
                Information
              </h5>
              <nav class="list-unstyled mb-0">
                <li class="mb-3 text-center text-md-start">
                  <Link
                    class="font-14 fw-medium lh-24 text-white text-decoration-none"
                    to="/"
                  >
                    Main
                  </Link>
            ...
            <div class="col-12 col-sm-6 col-lg-3 order-2 order-lg-3 d-flex flex-column justify-content-between align-items-center align-items-lg-start mt-4 mt-sm-0 pt-4 pt-sm-0 border-top-gray-one">
              <h5 class="font-16 fw-bold text-white mb-4 text-center text-md-start">
                Contacts
              </h5>
        ...
        <div class="border-top-gray-two pb-4 w-100 bg-gray-three">
          <div class="d-flex justify-content-center mt-4">
            <span class="font-16 fw-normal text-gray-two me-2">
              {" "}
              Frontend development:{" "}
            </span>
            <a
              class="font-16 fw-normal text-gray-two mb-0 text-decoration-none"
              target="_blank"
          ...
          <div class="d-flex justify-content-center">
            <span class="font-16 fw-normal text-gray-two mb-0 me-2">
          ...
          <p class="font-16 fw-normal text-gray-two text-center mt-3">
